...
- [x] **Autenticação Firebase** completa (Email + Google)
- [x] **Sistema de Terço Gamificado** com 20 mistérios
- [x] **Orações Tradicionais** autênticas
- [x] **Interface Católica** responsiva
- [x] **Sistema de Pontuação** e conquistas básicas
- [x] **Navegação Moderna** com Go Router
- [x] **Persistência Firebase** de dados
...
### **Licença MIT**
Este projeto está licenciado sob a Licença MIT - veja o arquivo [LICENSE.md](LICENSE.md) para detalhes completos.
...
### **Canais Oficiais**
- 📧 **Email Geral**: contato@katholiks.app
- 🛠️ **Suporte Técnico**: dev@katholiks.app
- ⛪ **Pastoral Digital**: pastoral@katholiks.app
- 🐛 **Report de Bugs**: bugs@katholiks.app

### **Redes Sociais**
- 📱 **Instagram**: [@katholiks_app](https://instagram.com/katholiks_app)
- 📘 **Facebook**: [Katholiks App](https://facebook.com/katholiks.app)
- 🐦 **Twitter**: [@KatholiksApp](https://twitter.com/KatholiksApp)
- 🎵 **TikTok**: [@katholiks.app](https://tiktok.com/@katholiks.app)
